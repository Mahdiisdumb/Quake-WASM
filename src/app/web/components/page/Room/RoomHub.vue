...
.room-hub
  ...
  .rooms
    RoomPreviewRow(
      v-for="room in roomHubStore.roomList" 
      :room="room"
...
import RoomPreviewRow from './components/RoomPreviewRow.vue'
...
const startCreate = async (creationParams: CreationParams) => {
  ...
  const newRoomName = creationParams.roomName
