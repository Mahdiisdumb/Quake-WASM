        ...
        .controls.columns
          .control-selection.column.col-8
            .general-fields
              .name Player Name
              .value
                QuakeTextInput(:maxLength="15" :modelValue="model.playerName" @update:modelValue="model.playerName = $event")
          ...
          .control-selection.column.col-6
            .button(
              ...
              .description 
                span Classic
    .modal-footer
      button.btn(@click="onOkClick") {{props.okText}}
